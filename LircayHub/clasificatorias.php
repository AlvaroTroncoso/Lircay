            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Clasificatorias Qatar 2021</h1>
                    
                    </div>

                    <section class="page-section about-heading">
                        <div class="container">
                            <img class="img-fluid rounded about-heading-img mb-3 mb-lg-0" src="img/chile.jpg" alt="..." />
                            <div class="about-heading-content">
                                <div class="row">
                                    <div class="col-xl-9 col-lg-10 mx-auto">
                                        <div class="bg-faded rounded p-5">
                                            <h2 class="section-heading mb-4">
                                                <span class="section-heading-upper">Las cinco "finales" que le quedan a Chile en las Eliminatorias Qatar 2022</span>
                                                
                                            </h2>
                                            <p>Las Eliminatorias Qatar 2022 entran en la recta final y Chile sigue acerc&aacute;ndose a los puestos de clasificaci&oacute;n
                                                al pr&oacute;ximo Mundial, especialmente luego del triunfo en condici&oacute;n de visita ante Paraguay.
                                                Ahora la Roja deber&aacute; enfocarse en su pr&oacute;ximo desaf&iacute;o que es enfrentar a Ecuador, pero en esta oportunidad como local.</p>
                                            <p class="mb-0">
                                                - Chile vs Ecuador, Santiago, martes 16 de noviembre
                        ...
                        <div class="container">
                            <img class="img-fluid rounded about-heading-img mb-3 mb-lg-0" src="img/chilito.png" alt="..." />
                            <div class="about-heading-content">
                                <div class="row">
                                    <div class="col-xl-9 col-lg-10 mx-auto">
                                        <div class="bg-faded rounded p-5">
                                            <h2 class="section-heading mb-4">
                                                <span class="section-heading-upper">¿Cu&aacute;ntos puntos necesita la Selección chilena para clasificar al Mundial Qatar 2022?</span>
                                                
                                            </h2>
                                            <p>La Roja de Lasarte marcha sexta en las Eliminatorias y todavía le queda un largo trecho por recorrer para meterse a la Copa del Mundo.

                                                Cada día que pasa nos acerca más al Mundial de Qatar 2022. En todo el mundo, los países buscan su boleto para la máxima cita de la pelota y la Selección chilena de Martín Lasarte quiere obtener su lugar desde las Eliminatorias sudamericanas.</p>
                                            <p class="mb-0">
                                               Tras trece fechas disputadas en el torneo clasificatorio de la CONMEBOL, la Roja suma 16 puntos sobre 42 posibles y se ubica en la sexta posición de la tabla tras el empate sin goles frente a Ecuador, una triste derrota en Barranquilla que la insertó en la parte baja, la derrota clara en Lima, que le condiciona en exceso, el desahogo en el 2-0 contra los paraguayos, la goleada frente a los venezolanos, el vital 1-0 en Asunción y la fea derrota ante los ecuatorianos que se condicionó desde un comienzo. Estos tres recientes gritos la invitaron a soñar, pero solo lleva 4 ganados en total.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container mt-5">
                            <div class="d-flex justify-content-center row">
                                <form action="agregarclasi.php" id="chat" onsubmit="filtro()" method="POST">
                    ...
                    <?php 
                        require("config.php");
                        $sqlVideo   = ("SELECT * FROM publicaciones WHERE id_tema=2");
